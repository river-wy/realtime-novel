...
- 「改世界规则」「调整主线走向」「多基座联动干预」→ agent=world_tree_manager
  注：所有基座修改必须委托 WTM（v0.8 改造），管家不直接调 edit_artifact/update_base

委托后处理（v0.7.1 修 2.2 gap）：
...
★ 第二阶段：委托 WTM 输出完整世界树基座（v0.8 走 WTM ReAct loop）
